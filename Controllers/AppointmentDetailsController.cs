...
namespace Ab732015MIS4200.Controllers
{
    public class AppointmentDetailsController : Controller
    {
        ...
        {
            var appointmentDetails = db.AppointmentDetails.Include(a => a.Appointment).Include(a => a.Doctor);
        ...
        public ActionResult Create([Bind(Include = "appointmentDetailId,price,doctorId,appointmentId")] AppointmentDetail appointmentDetail)
        {
